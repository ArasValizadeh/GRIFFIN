...
class Cryotheraphy(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        super().__init__(task_type='classification',train_size=63, *args, **kwargs)
...
class Haberman(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.target = 3
        super().__init__(task_type='classification',train_size=214, *args, **kwargs)
...
class Heart(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        super().__init__(task_type='classification',train_size=189, *args, **kwargs)
...
class Glass(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.df = data.iloc[:, :-1]
        self.target = data.iloc[:, -1]  # All rows, the last column
        super().__init__(task_type='classification',train_size=160, *args, **kwargs)
...
class Segmentaition(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.df = data.iloc[:, :-1]
        self.target = "class"
        super().__init__(task_type='classification',train_size=1500, *args, **kwargs)
...
class Wine(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.df = pd.read_csv(path, header=None)
        self.target = 0
        super().__init__(task_type="classification",train_size=124, *args, **kwargs)
...
class Thyroid(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.df = pd.read_csv(path, header=None)
        self.target = 0
        super().__init__(task_type='classification',train_size=150, *args, **kwargs)
...
class Autism(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        super().__init__(task_type='classification',train_size=737, *args, **kwargs)
...
class Iris(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.df = data.data
        super().__init__(task_type='classification',train_size=105, *args, **kwargs)


class CaliforniaHousing(Test):
    def __init__(self, *args, **kwargs) -> None:
        ...
        super().__init__(task_type='regression',train_size=int(0.7 * len(self.df)),*args, **kwargs)

class Abalone(Test):
    def __init__(self, *args, **kwargs) -> None:
        data = fetch_ucirepo(id=1)  # ID for Abalone in UCI repo
        ...
        super().__init__(train_size=int(len(self.df) * 0.7), task_type='regression', *args, **kwargs)